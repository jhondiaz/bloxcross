...
export default [
  ...
  },
  {
    ...
    meta: {
      beforeResolve(routeTo, routeFrom, next) {
        ...
        console.log(store.getters['authuser/loggedIn']);
        if (store.getters['authuser/loggedIn']) {
  ...
  {
    path: '/bloxcross/history',
    name: 'history-bloxcross',
    meta: { authRequired: true },
    component: () => import('./views/bloxcross/history/index')
  },
  {
    path: '/bloxcross/wallet',
    name: 'wallet-bloxcross',
    meta: { authRequired: true },
    component: () => import('./views/bloxcross/wallet/index')
  },
