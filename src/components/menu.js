export const menuItems = [
    ...
    {
        id: 2,
        label: "menuitems.bloxcross.text",
        icon: "bx-home-circle",
        badge: {
            variant: "info",
            text: "menuitems.bloxcross.badge"
        },
        subItems: [
            {
                id: 3,
                label: "menuitems.bloxcross.list.summary",
                link: "/",
                parentId: 2
            },
            {
                id: 4,
                label: "menuitems.bloxcross.list.wallet",
                link: "/bloxcross/wallet",
                parentId: 2
            },
            {
                id: 5,
                label: "menuitems.bloxcross.list.history",
                link: "/bloxcross/history",
                parentId: 2
            },
            {
                id: 6,
                label: "menuitems.bloxcross.list.security",
                link: "/dashboard/blog",
                parentId: 2
            }
        ]
